...
namespace Relacion2Clases
{
    ...
    class Grupo
    {
        ...
        static void LeeFicheroAlumno(List<Alumno> lista_alumnos, string nombre)
        {
            ...
            while (fs.Position < fs.Length)
            {
                ...
                datos.nombre = br.ReadString();
                datos.edad = br.ReadInt32();
                datos.calificacion = br.ReadDecimal();
                a.Add(datos);
